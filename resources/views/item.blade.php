    ...
    <div class="container ">
      <form class="row g-3">
        ...
        <div class="col-md-2 mx-4 ">
          ...
          <input type="file" class="form-control" id="img_item" name="img_item" placeholder="1234 Main St">
        </div>
        <div class="col-md-4">
        ...
        <div class="d-flex justify-content-center">
          ...
          <button type="submit" class="btn btn-secondary btn-lg-success">Sign in</button>
        </div>
        </div>
      </form>
    </div>
